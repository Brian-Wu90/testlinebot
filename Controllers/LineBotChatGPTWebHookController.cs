...
namespace isRock.Template
{
    public class LineBotChatGPTWebHookController : isRock.LineBot.LineWebHookControllerBase
    {
        ...
        public LineBotChatGPTWebHookController(IConfiguration configuration)
        {
        ...
        public IActionResult POST()
        {
            ...
            try
            {
                ...
                {
                    responseMsg = ChatGPT.getResponseFromGPT(LineEvent.message.text, _configuration);
                }
    ...
    public class ChatGPT
    {
        ...
        public static string getResponseFromGPT(string Message, IConfiguration configuration)
        {
